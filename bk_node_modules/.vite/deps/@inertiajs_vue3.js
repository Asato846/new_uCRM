import {
  ...
  require_lodash,
  require_lodash2
} from "./chunk-FDCUN7GP.js";
import {
  axios_default
} from "./chunk-UD2DN5OM.js";
import "./chunk-RJGW67SX.js";
import {
  computed,
  createSSRApp,
  defineComponent,
...
var F = class {
  ...
  visit(e, { method: i = "get", data: r = {}, replace: s = false, preserveScroll: l = false, preserveState: h2 = false, only: g2 = [], except: m = [], headers: c2 = {}, errorBag: o = "", forceFormData: v = false, onCancelToken: L2 = () => {
    ...
    axios_default({ method: i, url: E(S).href, data: i === "get" ? {} : r, params: i === "get" ? r : {}, signal: this.activeVisit.cancelToken.signal, headers: { ...c2, Accept: "text/html, application/xhtml+xml", "X-Requested-With": "XMLHttpRequest", "X-Inertia": true, ...j2 ? { "X-Inertia-Partial-Component": this.page.component } : {}, ...g2.length ? { "X-Inertia-Partial-Data": g2.join(",") } : {}, ...m.length ? { "X-Inertia-Partial-Except": m.join(",") } : {}, ...o && o.length ? { "X-Inertia-Error-Bag": o } : {}, ...this.page.version ? { "X-Inertia-Version": this.page.version } : {} }, onUploadProgress: (n) => {
      ...
      let a = n.data;
      j2 && a.component === this.page.component && (a.props = { ...this.page.props, ...a.props }), l = this.resolvePreserveOption(l, a), h2 = this.resolvePreserveOption(h2, a), h2 && window.history.state?.rememberedState && a.component === this.page.component && (a.rememberedState = window.history.state.rememberedState);
      let w = S, V = b(a.url);
  ...
  remember(e, i = "default") {
    C || this.replaceState({ ...this.page, rememberedState: { ...this.page?.rememberedState, [i]: e } });
  }
  restore(e = "default") {
    if (!C) return window.history.state?.rememberedState?.[e];
  }
  on(e, i) {
    if (C) return () => {
    };
...
function Q() {
  return reactive({ props: computed(() => d.value?.props), url: computed(() => d.value?.url), component: computed(() => d.value?.component), version: computed(() => d.value?.version), scrollRegions: computed(() => d.value?.scrollRegions), rememberedState: computed(() => d.value?.rememberedState) });
}
